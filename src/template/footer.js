var footerId = '#footer', footer = '<!--Footer-->' +
'<footer class="page-footer center-on-small-only stylish-color-dark" id="footer">' +
'<!--Footer Links-->' +
'<div class="container">' +
'<div class="row">' +
'<!--First column-->' +
...
'Footer Content' +
'</h5>' +
'<p>Here you can use rows and columns here to organize your footer content.' +
...
'<ul>' +
'<li>' +
'<h5 class="mb-1">Register for free</h5></li>' +
...
'<div class="container-fluid">© 2017 Copyright:' +
